...
# Build flags
readonly LDFLAGS="-X 'github.com/bluelightgit/octopus/internal/conf.Version=${GIT_VERSION}' \
                  -X 'github.com/bluelightgit/octopus/internal/conf.BuildTime=${BUILD_TIME}' \
                  -X 'github.com/bluelightgit/octopus/internal/conf.Author=${GIT_AUTHOR}' \
                  -X 'github.com/bluelightgit/octopus/internal/conf.Commit=${COMMIT_ID}' \
                  -s -w"
