...
export enum GroupRouteAffinityMode {
    Off = 'off',
    Auto = 'auto',
    Strict = 'strict',
}

export const GroupResponsesStatefulRoutingMode = GroupRouteAffinityMode;
export type GroupResponsesStatefulRoutingMode = GroupRouteAffinityMode;
