...
function formatOptionalDuration(ms: number | undefined, fallback: string): string {
                                                            ...
                                                            <div className="rounded-xl border border-border/60 bg-background/60 p-3">
                                                                ...
                                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-muted-foreground">
                                                                    <div className="flex items-center justify-between gap-3 rounded-lg bg-muted/40 px-2.5 py-2">
                                                                        <span>{t('upstreamFirstEvent')}</span>
                                                                        <span className="font-mono text-foreground">
                                                                            {formatOptionalDuration(log.upstream_first_event_ms, naLabel)}
                                                                        </span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between gap-3 rounded-lg bg-muted/40 px-2.5 py-2">
                                                                        <span>{t('clientFirstWrite')}</span>
                                                                        <span className="font-mono text-foreground">
                                                                            {formatOptionalDuration(log.client_first_write_ms, naLabel)}
                                                                        </span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between gap-3 rounded-lg bg-muted/40 px-2.5 py-2">
                                                                        <span>{t('upstreamEvents')}</span>
                                                                        <span className="font-mono text-foreground">
                                                                            {log.upstream_event_count ?? naLabel}
                                                                        </span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between gap-3 rounded-lg bg-muted/40 px-2.5 py-2">
                                                                        <span>{t('clientChunks')}</span>
                                                                        <span className="font-mono text-foreground">
                                                                    ...
                                                                    <div className="flex items-center justify-between gap-3 rounded-lg bg-muted/40 px-2.5 py-2">
                                                                        ...
                                                                        <span className="font-medium text-foreground">
                                                                            {log.terminal_seen === undefined ? naLabel : (log.terminal_seen ? t('yes') : t('no'))}
                                                                        </span>
                                                                    </div>
                                                                    <div className="flex items-center justify-between gap-3 rounded-lg bg-muted/40 px-2.5 py-2">
                                                                        <span>{t('failureStage')}</span>
