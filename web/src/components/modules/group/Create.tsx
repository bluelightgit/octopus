...
import { GroupProtocolFamily, GroupProtocolRoutingMode, GroupResponsesStatefulRoutingMode, type GroupItem } from '@/api/endpoints/group';
import {
    MorphingDialogClose,
    MorphingDialogTitle,
        ...
        <div className="w-screen max-w-full md:max-w-4xl h-[calc(100vh-2rem)] min-h-0 flex flex-col">
            ...
            <MorphingDialogDescription className="flex-1 min-h-0 overflow-hidden">
                <GroupEditor
                    ...
                    onSubmit={({ name, match_regex, mode, first_token_time_out, session_keep_time, preferred_protocol_family, protocol_routing_mode, responses_stateful_routing, members }) => {
